...
import { TravelguidelinesComponent } from './travelguidelines/travelguidelines.component';
...
const routes: Routes = [
  ...
  {path: 'Payment/travelguidelines',component:TravelguidelinesComponent},
  {path: 'Payment/travelguidelines/userdashboard',component:UserdashboardComponent}
];
